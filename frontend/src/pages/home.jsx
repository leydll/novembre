...
export default function Home({ user }) {
  ...
  return (
    <main>
      ...
      {siteDescription && (
        <section style={{ marginBottom: "2rem", padding: "1.5rem", background: "var(--color-white)", borderRadius: "20px", border: "1px solid var(--color-border)", boxShadow: "0px 2px 8px rgba(0, 0, 0, 0.04)" }}>
          <p style={{ lineHeight: "1.6", color: "var(--color-text)", fontSize: "1rem", margin: 0, whiteSpace: "pre-wrap" }}>
            {siteDescription}
          </p>
        </section>
      )}
